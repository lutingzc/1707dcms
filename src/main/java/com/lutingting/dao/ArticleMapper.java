...
public interface ArticleMapper {
	...
	@Insert("INSERT INTO cms_article("
			...
			+ "jdbcType=INTEGER,javaType=com.lutingting.entity.TypeEnum})")
	...
	@Insert(" REPLACE cms_favarite(user_id,article_id,created) "
			+ "VALUES(#{userId},#{articleId},now())")
	int favarite(@Param("userId") Integer userId,@Param("articleId") int articleId);
