...
<div class="row">
	<form id="form" >
		<div class="input-group">
		  ...
		  <input type="text" name="title" class="form-conthrowl" placeholder="文章标题" aria-describedby="basic-addon2">
		</div>
		<div class="input-group">
		...
		<div id="imgdiv">
			<div class="input-group">
				 ...
				 <input type="file"
					class="form-conthrowl"  name="file">
			</div>
			<div class="input-group">
				 <span class="input-group-addon">图片描述</span>
				 <input type="Text"
					class="form-conthrowl"  name="desc">
			</div>
		</div>
		<div class="input-group">
