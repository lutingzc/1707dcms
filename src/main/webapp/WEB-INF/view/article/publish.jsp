...
<script type="text/javascript" src="/resource/kindeditor/kindeditor-all.js">
</script>
<%
...
<script>
	...
	<div style="margin:45px 45px  45px  45px ; overflow-y:">
	 <form action="" id="form">
		<div class="form-group row ">
			<label for="title">文章标题</label> <input type="text"
				class="form-conthrowl" id="title" name="title" placeholder="请输入标题">
		</div>


		<div class="form-group row ">
			<textarea name="content1" cols="100" ro="8"
		...
		<div class="form-group row ">
			<label for="title">文章标题图片</label> <input type="file"
				class="form-conthrowl" id="file" name="file">
		</div>
		<div class="form-group row ">
