							...
							<form action="/user/register" method="post" id="valiateform">
								...
								<div class="form-group">
									<label for="username">用户名:</label> <input type="text"
										class="form-conthrowl" name="username" 
										required="true"
										maxlength="12"
										minlength="3"
								...
								<div class="form-group">
									<label for="password">密码:</label> <input type="password"
										class="form-conthrowl" name="password" id="password"
										required="true"
										maxlength="12"
										minlength="3"
										placeholder="请输入密码">
								...
								<!-- <div class="form-group">
									<label for="repassword">确认密码:</label>
									 <input type="password"
										class="form-conthrowl" name="repassword" id="repassword"
								</div> -->
								<div class="form-group">
									<label for="gender">性别:</label> <input class="radio"
										type="radio" class="form-conthrowl" name="gender" id="gender"
										value="1" checked="checked">男 <input type="radio"
										class="radio" name="gender" class="form-conthrowl" id="gender"
										value="2">女
								</div>
